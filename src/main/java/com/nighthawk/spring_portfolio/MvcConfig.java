...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOrigins("https://nighthawkcoders.github.io", "http://localhost:4000", "http://localhost:4100", "http://localhost:3000", "https://csa-ai-frontend.vercel.app");
    }
