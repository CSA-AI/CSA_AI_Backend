...
public class SecurityConfig {
		...
		public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
			http
				...
				.headers(headers -> headers
					...
					.addHeaderWriter(new StaticHeadersWriter("Access-Control-Allow-Origin", "https://csa-ai-frontend.vercel.app"))
				)
				.formLogin(form -> form 
	...
	private CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList( "https://csa-ai-frontend.vercel.app"));
